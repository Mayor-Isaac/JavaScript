...
// const x = new Array(7)
// console.log(x); //An empty array with 7 elements
/*x.fill(1)
console.log(x);*/
/*x.fill(1,3)
console.log(x);*/
...
// Creating [1,2,3,4,5,6,7] dynamically
// const y = Array.from({length : 7}, (currentElement, currentIndex) => currentIndex + 1)
// console.log(y);

// labelBalance.addEventListener('click', function () {
// const movementUI = document.querySelectorAll('.movements__value');
/*const movementUItextContent = movementUI.map(currentElement => currentElement.textContent)
  console.log(movementUItextContent); //error because querySelectorAll returns NodeList not Array*/
/*const movementUItextContent = Array.from(document.querySelectorAll('.movements__value'), (currentElement => currentElement.textContent))
  console.log(movementUItextContent);/*
  //Or
...
console.log(`Sum of all Deposits is ===> ${overAllDeposits}`);

//2) Number is all deposits made
const numberOfAllDeposits = accounts
  .flatMap(account => account.movements)
  .filter(account => account > 0)
  .reduce((acc) => acc + 1, 0);
console.log(`The number of all Deposits is ===> ${numberOfAllDeposits}`);

//3) Number is all deposits above 1000
const numberOfAllDepositsAbove1000 = accounts
  .flatMap(account => account.movements)
  .filter(account => account > 1000)
  .reduce((acc) => acc + 1, 0);
console.log(`The number of all Deposits above 1000 is ===> ${numberOfAllDepositsAbove1000 }`);
